  ...
  return (
    <div>
      <div className="flex flex-col items-center text-center py-14 px-6">
        ...
        <p className="text-sm font-medium text-gray-900">{label} isn&apos;t built yet</p>
        <p className="text-xs text-gray-500 mt-0.5">This section is coming in a future update.</p>
      </div>
